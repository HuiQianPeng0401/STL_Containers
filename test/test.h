...
#define CON_TEST_P1(con, fun, arg, len1, len2, len3)         \
  ...
  std::cout << "\n|        phq        |";                  \
  FUN_TEST_FORMAT1(phq::con, fun, arg, len1);              \
  FUN_TEST_FORMAT1(phq::con, fun, arg, len2);              \
  FUN_TEST_FORMAT1(phq::con, fun, arg, len3);    
...
#define CON_TEST_P2(con, fun, arg1, arg2, len1, len2, len3)  \
  ...
  std::cout << "\n|        phq        |";                  \
  FUN_TEST_FORMAT2(phq::con, fun, arg1, arg2, len1);       \
  FUN_TEST_FORMAT2(phq::con, fun, arg1, arg2, len2);       \
  FUN_TEST_FORMAT2(phq::con, fun, arg1, arg2, len3);    
...
#define MAP_EMPLACE_TEST(con, len1, len2, len3)              \
  ...
  std::cout << "\n|        phq        |";                  \
  MAP_EMPLACE_DO_TEST(phq, con, len1);                     \
  MAP_EMPLACE_DO_TEST(phq, con, len2);                     \
  MAP_EMPLACE_DO_TEST(phq, con, len3);
...
#define LIST_SORT_TEST(len1, len2, len3)                     \
  ...
  std::cout << "\n|        phq        |";                  \
  LIST_SORT_DO_TEST(phq, len1);                            \
  LIST_SORT_DO_TEST(phq, len2);                            \
  LIST_SORT_DO_TEST(phq, len3);
...
#define RUN_ALL_TESTS() \
  phq::test::UnitTest::GetInstance()->Run()
